# Contributing to Reliefflow

Thank you for contributing to Reliefflow! This guide will help you get started.
...
```bash
git clone https://github.com/grantfox-org/reliefflow.git
cd reliefflow
pnpm install
pnpm dev
```
...
fix: resolve storage collision in reliefflow
...
Open a [Discussion](https://github.com/grantfox-org/reliefflow/discussions) on GitHub.
