//! Audit Trail Integrity Tests — #467
//! Author: Kayode Alabi (2026-03-16)
//!
...
#[test]
fn test_disbursement_event_schema_467() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_fraud_challenge_event_467() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_campaign_closure_event_467() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_dedup_attempt_logged_467() {
    let env = Env::default();
    env.mock_all_auths();
