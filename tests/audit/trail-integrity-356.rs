//! Audit Trail Integrity Tests — #356
...
#[test]
fn test_disbursement_event_schema_356() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_fraud_challenge_event_356() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_campaign_closure_event_356() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_dedup_attempt_logged_356() {
    let env = Env::default();
    env.mock_all_auths();
