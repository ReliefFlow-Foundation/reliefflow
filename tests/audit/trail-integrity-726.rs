//! Audit Trail Integrity Tests — #726
...
#[test]
fn test_disbursement_event_schema_726() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_fraud_challenge_event_726() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_campaign_closure_event_726() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_dedup_attempt_logged_726() {
    let env = Env::default();
    env.mock_all_auths();
