//! Audit Trail Integrity Tests — #207
//! Author: Chinyere Okafor (2026-04-29)
//!
...
#[test]
fn test_disbursement_event_schema_207() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_fraud_challenge_event_207() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_campaign_closure_event_207() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_dedup_attempt_logged_207() {
    let env = Env::default();
    env.mock_all_auths();
