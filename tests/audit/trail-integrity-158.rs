//! Audit Trail Integrity Tests — #158
//! Author: Nour Khalil (2026-04-01)
//!
...
#[test]
fn test_disbursement_event_schema_158() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_fraud_challenge_event_158() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_campaign_closure_event_158() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_dedup_attempt_logged_158() {
    let env = Env::default();
    env.mock_all_auths();
