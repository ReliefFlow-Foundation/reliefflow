# GitHub Issues Backlog — Reliefflow

## Batch 1 — Foundation & Scaffolding (Phase 1)

### Issue 1: Initialize `beneficiary-registry` contract scaffold
...
### Issue 2: Define storage data types for `beneficiary-registry`
**Labels:** `contracts` `good first issue` `phase-1`
...
### Issue 3: Implement `beneficiary-registry` core write functions
...
### Issue 4: Implement `beneficiary-registry` query functions
**Labels:** `contracts` `good first issue` `phase-1`
...
### Issue 5: Initialize `aid-escrow` contract scaffold
**Labels:** `contracts` `good first issue` `phase-1`
Mirror of Issue 1 for the `aid-escrow` contract.
**Acceptance Criteria:** Compiles, `initialize` called once, version exposed.

---

### Issue 6: Implement `aid-escrow` pool/management logic
**Labels:** `contracts` `phase-1`
Implement the core pooling or management logic unique to `aid-escrow`.
**Acceptance Criteria:** Integration test simulates full lifecycle, edge cases covered.

---

### Issue 7: Initialize `fraud-challenge` contract scaffold
**Labels:** `contracts` `good first issue` `phase-1`
Scaffold the `fraud-challenge` contract with required entrypoints.
**Acceptance Criteria:** Compiles, unit tested.

---

### Issue 8: Implement `fraud-challenge` execution logic
**Labels:** `contracts` `phase-1`
